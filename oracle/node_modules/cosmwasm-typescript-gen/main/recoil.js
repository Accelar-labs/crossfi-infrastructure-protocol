...
var _default = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(name, schemas, outPath) {
    var RecoilFile, Contract, QueryMsg, Types, QueryClient, ReadOnlyInstance, body, allTypes, typ, result, typeHash, code;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            QueryMsg = schemas.find(function (schema) {
              return schema.title === 'QueryMsg';
            });
            Types = schemas.filter(function (schema) {
              return schema.title !== 'ExecuteMsg' && schema.title !== 'ExecuteMsg_for_Empty' && schema.title !== 'QueryMsg';
            });
            QueryClient = null;
          ...
          case 11:
            ...
            _context.next = 15;
            return (0, _jsonSchemaToTypescript.compile)(Types[typ], typ);
