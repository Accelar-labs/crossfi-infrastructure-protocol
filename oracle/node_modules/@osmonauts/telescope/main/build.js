...
var buildBaseTypeScriptClass = function buildBaseTypeScriptClass(context, name, obj) {
  context.body.push((0, _ast.createCreateProtoType)(name, obj));
...
var buildEnums = function buildEnums(context, name, obj) {
  context.body.push((0, _ast.createProtoEnum)(name, obj));
  context.body.push((0, _ast.createProtoEnumFromJSON)(name, obj));
  context.body.push((0, _ast.createProtoEnumToJSON)(name, obj));
};
