...
exports.getImportsFromQueries = exports.getImportsFromMutations = exports.getDepsFromQueries = exports.getDepsFromMutations = exports.buildAllImports = void 0;
...
var getImportStatments = function getImportStatments(list) {
...
var buildAllImports = function buildAllImports(context, allImports, filepath) {
  ...
  var importStmts = getImportStatments(list);
  return importStmts;
};
...
var getDepsFromMutations = function getDepsFromMutations(mutations, filename) {
  return getImportsFromMutations(mutations).map(function (imp) {
    ...
    var f2 = imp["import"];
    if (f === f2) return;
    var rel = (0, _path.relative)((0, _path.dirname)(f), f2);
