...
export const createAminoConverterItem = ({
  ...
  return t.objectProperty(t.stringLiteral(typeUrl), t.objectExpression([t.objectProperty(t.identifier('aminoType'), t.stringLiteral(typeUrlToAmino(typeUrl, context.options.aminoExceptions))), t.objectProperty(t.identifier('toAmino'), toAminoJsonMethod({
    context,
    proto
