...
import { getDefaultTSTypeFromProtoType, getFieldsTypeName } from '..'; // message.sender = expr
...
export const fromPartial = {
  ...
  string(args) {
    ...
    return setNullishCoalescing(prop, getDefaultTSTypeFromProtoType(args.field, args.isOptional));
  },
  ...
  long(args) {
    const prop = args.field.name;
    return setNotUndefinedAndNotNull(prop, t.callExpression(t.memberExpression(t.identifier('Long'), t.identifier('fromValue')), [t.memberExpression(t.identifier('object'), t.identifier(prop))]), getDefaultTSTypeFromProtoType(args.field, args.isOptional));
  },
