...
export const fromPartialMethod = (context, name, proto) => {
  ...
  if (context.useExact === true) {
    ...
    // param
    param = identifier(varName, t.tsTypeAnnotation(t.tsTypeReference(t.identifier('DeepPartial'), t.tsTypeParameterInstantiation([t.tsTypeReference(t.identifier(name))]))));
  }
