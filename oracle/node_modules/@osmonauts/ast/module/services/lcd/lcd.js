...
const makeLCDClientClassBody = (clientName, methods) => {
...
export const makeLCDClient = (context, service) => {
...
export const makeAggregatedLCDClient = (context, services, clientName) => {
  context.addUtil('LCDClient');
