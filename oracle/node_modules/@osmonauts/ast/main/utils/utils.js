...
exports.shorthandProperty = exports.renderNameSafely = exports.recursiveNamespace = exports.promiseTypeAnnotation = exports.memberExpressionOrIdentifierAminoCasing = exports.memberExpressionOrIdentifierAminoCaseField = exports.memberExpressionOrIdentifier = exports.importStmt = exports.commentBlock = exports.cleanComment = exports.bindMethod = exports.BILLION = void 0;
...
var commentBlock = function commentBlock(comment) {
  if (!/[\n]+/.test(comment)) {
    return {
      type: 'CommentBlock',
  ...
  var comments = lines.map(function (line, i) {
    ...
    return " * ".concat(cleanComment(line));
  });
  return {
    type: 'CommentBlock',
    value: comments.join('\n')
