...
exports.makeTemplateTag = exports.makeLCDClient = exports.makeAggregatedLCDClient = exports.getUrlTemplateString = void 0;
...
var makeLCDClientClassBody = function makeLCDClientClassBody(clientName, methods) {
...
var makeLCDClient = function makeLCDClient(context, service) {
  ...
  if (methods.length) {
    var clientName = firstUpper(service.name) + 'Client';
    return makeLCDClientClassBody(clientName, methods);
  }
};

exports.makeLCDClient = makeLCDClient;

var makeAggregatedLCDClient = function makeAggregatedLCDClient(context, services, clientName) {
  context.addUtil('LCDClient');
...
exports.makeAggregatedLCDClient = makeAggregatedLCDClient;