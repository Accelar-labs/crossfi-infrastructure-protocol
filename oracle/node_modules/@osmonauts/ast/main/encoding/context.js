...
var AminoParseContext = /*#__PURE__*/function (_GenericParseContext) {
  ...
  function AminoParseContext(ref, store, options) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "store", void 0);
  ...
  (0, _createClass2["default"])(AminoParseContext, [{
    ...
    value: function setAminoCasingFn() {
      ...
      this.aminoCasingFn = (0, _plugins.getPluginValue)('aminoCasingFn', this.ref.proto["package"], this.options);
      return this.aminoCasingFn;
    }
  }, {
    key: "aminoCaseField",
    value: function aminoCaseField(field) {
      var orig = field.options['(telescope:orig)']; // const name = field.options['(telescope:name)'];
...
var ProtoParseContext = /*#__PURE__*/function (_GenericParseContext2) {
  ...
  function ProtoParseContext(ref, store, options) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this2), "store", void 0);
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this2), "ref", void 0);
