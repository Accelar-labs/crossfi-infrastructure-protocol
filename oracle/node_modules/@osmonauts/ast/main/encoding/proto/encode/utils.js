...
var types = {
  ...
  */
  ...
  //   }
  "enum": function _enum(num, prop, isOptional) {
    return t.ifStatement(wrapOptional(prop, notZero(prop), isOptional), scalarType(num, prop, 'int32'));
  },
