...
var encodeMethod = function encodeMethod(context, name, proto) {
  ...
  var body = [].concat((0, _toConsumableArray2["default"])(fields), [
  /* RETURN writer */
  ...
  return (0, _utils.objectMethod)('method', t.identifier('encode'), [// args
  (0, _utils.identifier)(varName, t.tsTypeAnnotation(t.tsTypeReference(t.identifier(name))), false), t.assignmentPattern((0, _utils.identifier)('writer', t.tsTypeAnnotation(t.tsTypeReference(t.tsQualifiedName(t.identifier('_m0'), t.identifier('Writer'))))), t.callExpression(t.memberExpression(t.memberExpression(t.identifier('_m0'), t.identifier('Writer')), t.identifier('create')), []))], // body 
  t.blockStatement(body), false, false, false, // return type
