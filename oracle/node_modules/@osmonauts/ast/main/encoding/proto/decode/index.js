...
var decodeMethod = function decodeMethod(context, name, proto) {
  ...
  */
   ...
   */
  t.variableDeclaration('const', [t.variableDeclarator(t.identifier('message'), t.callExpression(t.identifier((0, _types2.getBaseCreateTypeFuncName)(name)), []))]), ///////////
  ///////////
  ///////////
  ...
  */
  ...
  t.returnStatement(t.identifier('message'))]), false, false, false, t.tsTypeAnnotation(t.tsTypeReference(t.identifier(name))));
};
