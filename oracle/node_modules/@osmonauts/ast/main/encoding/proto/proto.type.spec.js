    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          context = new _context8.ProtoParseContext(ref, store, _types2.defaultTelescopeOptions);
          expectCode((0, _types.createProtoType)(context, 'ListValue', (0, _protoParser.getNestedProto)(ref.traversed).ListValue));
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ref = store.findProto('google/protobuf/struct.proto');
          context = new _context8.ProtoParseContext(ref, store, _types2.defaultTelescopeOptions);
          expectCode((0, _types.createProtoType)(context, 'Struct', (0, _protoParser.getNestedProto)(ref.traversed).Struct));
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ref = store.findProto('google/protobuf/struct.proto');
            context = new _context8.ProtoParseContext(ref, store, _types2.defaultTelescopeOptions);
            expectCode((0, _types.createProtoType)(context, 'Value', (0, _protoParser.getNestedProto)(ref.traversed).Value));
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          context = new _context8.ProtoParseContext(ref, store, _types2.defaultTelescopeOptions);
          expectCode((0, _types.createProtoType)(context, 'authz', (0, _protoParser.getNestedProto)(_authz["default"]).Grant));
...
describe('createCreateProtoType', function () {
  it('Grant', function () {
    expectCode((0, _types.createCreateProtoType)('Grant', (0, _protoParser.getNestedProto)(_authz["default"]).Grant));
  });
  it('MsgJoinPool', function () {
    expectCode((0, _types.createCreateProtoType)('MsgJoinPool', (0, _protoParser.getNestedProto)(_tx["default"]).MsgJoinPool));
  });
});
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            context = new _context8.ProtoParseContext(ref, store, _types2.defaultTelescopeOptions);
            expectCode((0, _types.createProtoType)(context, 'Params', res.root.nested.osmosis.nested.claim.nested.v1beta1.nested.Params));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            context = new _context8.ProtoParseContext(ref, store, _types2.defaultTelescopeOptions);
            expectCode((0, _types.createProtoType)(context, 'Config', node.Config));
            expectCode((0, _types.createProtoType)(context, 'ModuleConfig', node.ModuleConfig));
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            res = (0, _protoParser.traverse)(store, ref);
            node = (0, _protoParser.getNestedProto)(res);
            context = new _context8.ProtoParseContext(ref, store, _types2.defaultTelescopeOptions); // console.log(JSON.stringify(res, null, 2))

            expectCode((0, _types.createProtoType)(context, 'CheckedExpr', node.CheckedExpr));
            expectCode((0, _types.createProtoType)(context, 'Reference', node.Reference));
