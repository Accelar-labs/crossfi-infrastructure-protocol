...
var fromPartialMethodFields = function fromPartialMethodFields(context, name, proto) {
  ...
  var fields = Object.keys((_proto$fields = proto.fields) !== null && _proto$fields !== void 0 ? _proto$fields : {}).map(function (fieldName) {
    ...
    var isOptional = (0, _.getFieldOptionality)(field, isOneOf);
    var args = {
      context: context,
      field: field,
...
var fromPartialMethod = function fromPartialMethod(context, name, proto) {
  ...
  if (context.useExact === true) {
    ...
    useExact = true; // type params

    typeParameters = t.tsTypeParameterDeclaration([t.tsTypeParameter(t.tsTypeReference(t.identifier('Exact'), t.tsTypeParameterInstantiation([t.tsTypeReference(t.identifier('DeepPartial'), t.tsTypeParameterInstantiation([t.tsTypeReference(t.identifier(name))])), t.tsTypeReference(t.identifier('I'))])), null, 'I')]); // param

    param = (0, _utils.identifier)(varName, t.tsTypeAnnotation(t.tsTypeReference(t.identifier('I'))));
  } else {
    // param
    param = (0, _utils.identifier)(varName, t.tsTypeAnnotation(t.tsTypeReference(t.identifier('DeepPartial'), t.tsTypeParameterInstantiation([t.tsTypeReference(t.identifier(name))]))));
  }

  return (0, _utils.objectMethod)('method', t.identifier('fromPartial'), [param], t.blockStatement([// init 
  t.variableDeclaration('const', [t.variableDeclarator(t.identifier('message'), t.callExpression(t.identifier((0, _types2.getBaseCreateTypeFuncName)(name)), []))])].concat((0, _toConsumableArray2["default"])(fields), [// RETURN 
