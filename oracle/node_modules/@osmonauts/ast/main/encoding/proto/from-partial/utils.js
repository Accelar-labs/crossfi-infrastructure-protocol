...
var fromPartial = {
  ...
  string: function string(args) {
    ...
    return setNullishCoalescing(prop, (0, _.getDefaultTSTypeFromProtoType)(args.field, args.isOptional));
  },
  ...
  "long": function long(args) {
    var prop = args.field.name;
    return setNotUndefinedAndNotNull(prop, t.callExpression(t.memberExpression(t.identifier('Long'), t.identifier('fromValue')), [t.memberExpression(t.identifier('object'), t.identifier(prop))]), (0, _.getDefaultTSTypeFromProtoType)(args.field, args.isOptional));
  },
  ...
  type: function type(args) {
    var prop = args.field.name;
    var name = (0, _.getFieldsTypeName)(args.field);
