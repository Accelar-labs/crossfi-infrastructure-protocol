...
var toJSON = {
  ...
  "long": function long(args) {
    ...
    var prop = args.field.name;
    return notUndefinedSetValue(prop, t.callExpression(t.memberExpression(t.logicalExpression('||', t.memberExpression(t.identifier('message'), t.identifier(prop)), (0, _.getDefaultTSTypeFromProtoType)(args.field, args.isOptional)), t.identifier('toString')), []));
  },
  ...
  bytes: function bytes(args) {
    ...
    if (args.isOptional) {
      ...
      // message.queryData !== undefined && (obj.queryData = base64FromBytes(message.queryData !== undefined ? message.queryData : new Uint8Array()));
      expr = t.callExpression(t.identifier('base64FromBytes'), [t.conditionalExpression(t.binaryExpression('!==', t.memberExpression(t.identifier('message'), t.identifier(args.field.name)), t.identifier('undefined')), t.memberExpression(t.identifier('message'), t.identifier(args.field.name)), (0, _.getDefaultTSTypeFromProtoType)(args.field, args.isOptional))]);
    }
...
var arrayTypes = {
  ...
  // }
  "long": function long(args) {
    return t.callExpression(t.memberExpression(t.logicalExpression('||', t.identifier('e'), (0, _.getDefaultTSTypeFromProtoType)(_objectSpread(_objectSpread({}, args.field), {}, {
  ...
  bytes: function bytes(args) {
    args.context.addUtil('base64FromBytes');
    return t.callExpression(t.identifier('base64FromBytes'), [t.conditionalExpression(t.binaryExpression('!==', t.identifier('e'), t.identifier('undefined')), t.identifier('e'), (0, _.getDefaultTSTypeFromProtoType)(_objectSpread(_objectSpread({}, args.field), {}, {
      rule: undefined // so it's treated as type not an array...
