...
var fromAmino = {
  ...
  height: function height(args) {
    args.context.addUtil('Long');
    return t.objectProperty(t.identifier(args.field.name), t.conditionalExpression((0, _utils.memberExpressionOrIdentifierAminoCaseField)(args.fieldPath, args.context.aminoCaseField), t.objectExpression([t.objectProperty(t.identifier('revisionHeight'), t.callExpression(t.memberExpression(t.identifier('Long'), t.identifier('fromString')), [t.logicalExpression('||', t.memberExpression((0, _utils.memberExpressionOrIdentifierAminoCaseField)(args.fieldPath, args.context.aminoCaseField), t.identifier(args.context.options.aminoCasingFn('revision_height'))), t.stringLiteral('0')), t.booleanLiteral(true)])), //
    t.objectProperty(t.identifier('revisionNumber'), t.callExpression(t.memberExpression(t.identifier('Long'), t.identifier('fromString')), [t.logicalExpression('||', t.memberExpression((0, _utils.memberExpressionOrIdentifierAminoCaseField)(args.fieldPath, args.context.aminoCaseField), t.identifier(args.context.options.aminoCasingFn('revision_number'))), t.stringLiteral('0')), t.booleanLiteral(true)]))]), t.identifier('undefined')));
  },
