...
exports.typeUrlToAmino = exports.protoFieldsToArray = exports.getTypeUrl = exports.arrayTypeNDim = void 0;
...
var getTypeUrl = function getTypeUrl(root, proto) {
  return "/".concat(root["package"], ".").concat(proto.name);
};
...
var typeUrlToAmino = function typeUrlToAmino(typeUrl) {
  var _exceptionsToCheck$ty;

  var exceptions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

  var exceptionsToCheck = _objectSpread(_objectSpread({}, exceptions), _types2.DEFAULT_AMINO_EXCEPTIONS);
  ...
  switch (pkg) {
    case 'cosmos':
    case 'ibc':
      return "cosmos-sdk/".concat(elements[elements.length - 1]);
...
exports.typeUrlToAmino = typeUrlToAmino;
