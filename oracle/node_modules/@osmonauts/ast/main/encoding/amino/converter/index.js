...
var createAminoConverterItem = function createAminoConverterItem(_ref) {
  ...
  return t.objectProperty(t.stringLiteral(typeUrl), t.objectExpression([t.objectProperty(t.identifier('aminoType'), t.stringLiteral((0, _utils.typeUrlToAmino)(typeUrl, context.options.aminoExceptions))), t.objectProperty(t.identifier('toAmino'), (0, _toAminoJson.toAminoJsonMethod)({
    context: context,
    proto: proto
  })), t.objectProperty(t.identifier('fromAmino'), (0, _fromAminoJson.fromAminoJsonMethod)({
    context: context,
    proto: proto
  }))]));
};
