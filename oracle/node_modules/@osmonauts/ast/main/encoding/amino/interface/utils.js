...
var _types2 = require("../../proto/types");
...
var aminoInterface = {
  defaultType: function defaultType(args) {
    return t.tsPropertySignature(t.identifier(args.context.aminoCaseField(args.field)), t.tsTypeAnnotation((0, _types2.getTSTypeFromProtoType)(args.field.type)));
  },
  ...
  type: function type(_ref) {
    ...
    var properties = (0, _utils.protoFieldsToArray)(Type).map(function (field) {
      ...
      var isOptional = (0, _proto.getFieldOptionality)(field, isOneOf); // TODO how to handle isOptional from parent to child...
  ...
  typeArray: function typeArray(_ref2) {
    ...
    var parentField = field;
    var Type = context.getTypeFromCurrentPath(field, currentProtoPath); // TODO how to handle isOptional from parent to child... 
  ...
  array: function array(args) {
    ...
    //     )
    // );
    return t.tsPropertySignature(t.identifier(args.context.aminoCaseField(args.field)), t.tsTypeAnnotation((0, _utils.arrayTypeNDim)((0, _types2.getTSTypeFromProtoType)(args.field.type), 1)));
  }
};
