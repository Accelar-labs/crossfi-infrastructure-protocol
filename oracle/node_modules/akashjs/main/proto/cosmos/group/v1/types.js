...
var DecisionPolicyWindows = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      votingPeriod: (0, _helpers.isSet)(object.votingPeriod) ? String(object.votingPeriod) : undefined,
      minExecutionPeriod: (0, _helpers.isSet)(object.minExecutionPeriod) ? String(object.minExecutionPeriod) : undefined
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
...
var GroupInfo = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      metadata: (0, _helpers.isSet)(object.metadata) ? String(object.metadata) : "",
      version: (0, _helpers.isSet)(object.version) ? _helpers.Long.fromString(object.version) : _helpers.Long.UZERO,
...
var GroupMember = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      groupId: (0, _helpers.isSet)(object.groupId) ? _helpers.Long.fromString(object.groupId) : _helpers.Long.UZERO,
...
var Proposal = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      groupVersion: (0, _helpers.isSet)(object.groupVersion) ? _helpers.Long.fromString(object.groupVersion) : _helpers.Long.UZERO,
      groupPolicyVersion: (0, _helpers.isSet)(object.groupPolicyVersion) ? _helpers.Long.fromString(object.groupPolicyVersion) : _helpers.Long.UZERO,
