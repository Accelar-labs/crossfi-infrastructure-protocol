...
var _types = require("../../escrow/v1beta1/types");
...
var QueryGroupRequest = {
  encode: function encode(message) {
    ...
    if (message.id !== undefined) {
      _group.GroupID.encode(message.id, writer.uint32(10).fork()).ldelim();
    }
  ...
  decode: function decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.id = _group.GroupID.decode(reader, reader.uint32());
          break;
  ...
  fromJSON: function fromJSON(object) {
    return {
      id: (0, _helpers.isSet)(object.id) ? _group.GroupID.fromJSON(object.id) : undefined
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.id !== undefined && (obj.id = message.id ? _group.GroupID.toJSON(message.id) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseQueryGroupRequest();
    message.id = object.id !== undefined && object.id !== null ? _group.GroupID.fromPartial(object.id) : undefined;
    return message;
  }
};
