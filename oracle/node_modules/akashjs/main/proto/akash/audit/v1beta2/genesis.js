...
var GenesisState = {
  encode: function encode(message) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        _audit.AuditedAttributes.encode(v, writer.uint32(10).fork()).ldelim();
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
  ...
  decode: function decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.attributes.push(_audit.AuditedAttributes.decode(reader, reader.uint32()));
          break;
  ...
  fromJSON: function fromJSON(object) {
    return {
      attributes: Array.isArray(object === null || object === void 0 ? void 0 : object.attributes) ? object.attributes.map(function (e) {
        return _audit.AuditedAttributes.fromJSON(e);
      }) : []
    };
  },
  toJSON: function toJSON(message) {
    ...
    if (message.attributes) {
      obj.attributes = message.attributes.map(function (e) {
        return e ? _audit.AuditedAttributes.toJSON(e) : undefined;
      });
    } else {
      obj.attributes = [];
    }
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.attributes = ((_object$attributes = object.attributes) === null || _object$attributes === void 0 ? void 0 : _object$attributes.map(function (e) {
      return _audit.AuditedAttributes.fromPartial(e);
    })) || [];
    return message;
  }
};
