...
var GenesisState = {
  encode: function encode(message) {
    ...
    var _iterator2 = _createForOfIteratorHelper(message.leases),
        _step2;
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        _lease.Lease.encode(_v, writer.uint32(18).fork()).ldelim();
      }
    } catch (err) {
      _iterator2.e(err);
    } finally {
  ...
  decode: function decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          message.leases.push(_lease.Lease.decode(reader, reader.uint32()));
          break;
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      leases: Array.isArray(object === null || object === void 0 ? void 0 : object.leases) ? object.leases.map(function (e) {
        return _lease.Lease.fromJSON(e);
      }) : [],
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.leases) {
      obj.leases = message.leases.map(function (e) {
        return e ? _lease.Lease.toJSON(e) : undefined;
      });
    } else {
      obj.leases = [];
    }
  ...
  fromPartial: function fromPartial(object) {
    var _object$orders, _object$leases;
    ...
    message.leases = ((_object$leases = object.leases) === null || _object$leases === void 0 ? void 0 : _object$leases.map(function (e) {
      return _lease.Lease.fromPartial(e);
    })) || [];
