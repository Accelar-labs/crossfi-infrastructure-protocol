...
var QueryAccountsRequest = {
  ...
  fromPartial: function fromPartial(object) {
    var _object$scope, _object$xid, _object$owner, _object$state;
    ...
    message.state = (_object$state = object.state) !== null && _object$state !== void 0 ? _object$state : "";
...
var QueryAccountsResponse = {
  encode: function encode(message) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        _types.Account.encode(v, writer.uint32(10).fork()).ldelim();
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
  ...
  decode: function decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.accounts.push(_types.Account.decode(reader, reader.uint32()));
          break;
  ...
  fromJSON: function fromJSON(object) {
    return {
      accounts: Array.isArray(object === null || object === void 0 ? void 0 : object.accounts) ? object.accounts.map(function (e) {
        return _types.Account.fromJSON(e);
      }) : [],
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.accounts) {
      obj.accounts = message.accounts.map(function (e) {
        return e ? _types.Account.toJSON(e) : undefined;
      });
    } else {
      obj.accounts = [];
    }
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.accounts = ((_object$accounts = object.accounts) === null || _object$accounts === void 0 ? void 0 : _object$accounts.map(function (e) {
      return _types.Account.fromPartial(e);
    })) || [];
...
var QueryPaymentsRequest = {
  encode: function encode(message) {
    ...
    if (message.pagination !== undefined) {
      _pagination.PageRequest.encode(message.pagination, writer.uint32(50).fork()).ldelim();
    }
  ...
  decode: function decode(input, length) {
    var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    var end = length === undefined ? reader.len : reader.pos + length;
    var message = createBaseQueryPaymentsRequest();
  ...
  fromPartial: function fromPartial(object) {
    var _object$scope2, _object$xid2, _object$id, _object$owner2, _object$state2;

    var message = createBaseQueryPaymentsRequest();
    message.scope = (_object$scope2 = object.scope) !== null && _object$scope2 !== void 0 ? _object$scope2 : "";
    message.xid = (_object$xid2 = object.xid) !== null && _object$xid2 !== void 0 ? _object$xid2 : "";
...
exports.QueryPaymentsRequest = QueryPaymentsRequest;
...
var QueryPaymentsResponse = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();

    var _iterator2 = _createForOfIteratorHelper(message.payments),
        _step2;
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        _types.FractionalPayment.encode(v, writer.uint32(10).fork()).ldelim();
      }
    } catch (err) {
      _iterator2.e(err);
    } finally {
  ...
  decode: function decode(input, length) {
    var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    var end = length === undefined ? reader.len : reader.pos + length;
    var message = createBaseQueryPaymentsResponse();
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.payments.push(_types.FractionalPayment.decode(reader, reader.uint32()));
          break;
  ...
  fromJSON: function fromJSON(object) {
    return {
      payments: Array.isArray(object === null || object === void 0 ? void 0 : object.payments) ? object.payments.map(function (e) {
        return _types.FractionalPayment.fromJSON(e);
      }) : [],
      pagination: (0, _helpers.isSet)(object.pagination) ? _pagination.PageResponse.fromJSON(object.pagination) : undefined
    };
  },
  toJSON: function toJSON(message) {
    ...
    if (message.payments) {
      obj.payments = message.payments.map(function (e) {
        return e ? _types.FractionalPayment.toJSON(e) : undefined;
      });
    } else {
      obj.payments = [];
    }
  ...
  fromPartial: function fromPartial(object) {
    var _object$payments;

    var message = createBaseQueryPaymentsResponse();
    message.payments = ((_object$payments = object.payments) === null || _object$payments === void 0 ? void 0 : _object$payments.map(function (e) {
      return _types.FractionalPayment.fromPartial(e);
    })) || [];
    message.pagination = object.pagination !== undefined && object.pagination !== null ? _pagination.PageResponse.fromPartial(object.pagination) : undefined;
    return message;
  }
};
exports.QueryPaymentsResponse = QueryPaymentsResponse;