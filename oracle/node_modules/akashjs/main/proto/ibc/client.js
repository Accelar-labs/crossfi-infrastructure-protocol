      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            aminoTypes = new _stargate.AminoTypes(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, ibcApplicationsTransferV1TxAmino.AminoConverter), ibcCoreChannelV1TxAmino.AminoConverter), ibcCoreClientV1TxAmino.AminoConverter), ibcCoreConnectionV1TxAmino.AminoConverter));
            _context.next = 5;
