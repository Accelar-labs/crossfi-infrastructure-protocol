...
var BlockParams = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      timeIotaMs: (0, _helpers.isSet)(object.timeIotaMs) ? _helpers.Long.fromString(object.timeIotaMs) : _helpers.Long.ZERO
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
...
var EvidenceParams = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      maxAgeNumBlocks: (0, _helpers.isSet)(object.maxAgeNumBlocks) ? _helpers.Long.fromString(object.maxAgeNumBlocks) : _helpers.Long.ZERO,
      maxAgeDuration: (0, _helpers.isSet)(object.maxAgeDuration) ? String(object.maxAgeDuration) : undefined,
      maxBytes: (0, _helpers.isSet)(object.maxBytes) ? _helpers.Long.fromString(object.maxBytes) : _helpers.Long.ZERO
    };
  },
  toJSON: function toJSON(message) {
...
var HashedParams = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      blockMaxBytes: (0, _helpers.isSet)(object.blockMaxBytes) ? _helpers.Long.fromString(object.blockMaxBytes) : _helpers.Long.ZERO,
      blockMaxGas: (0, _helpers.isSet)(object.blockMaxGas) ? _helpers.Long.fromString(object.blockMaxGas) : _helpers.Long.ZERO
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
