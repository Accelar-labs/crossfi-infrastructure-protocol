...
export const ModuleDescriptor = {
  ...
  fromJSON(object) {
    return {
      ...
      usePackage: Array.isArray(object?.usePackage) ? object.usePackage.map(e => PackageReference.fromJSON(e)) : [],
      canMigrateFrom: Array.isArray(object?.canMigrateFrom) ? object.canMigrateFrom.map(e => MigrateFromInfo.fromJSON(e)) : []
    };
  },
